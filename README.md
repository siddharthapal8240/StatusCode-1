![Alt Text](app/src/images/logopng.png)
...
## Acknowledgement 🙏
We, team EnigmaX, would like to extend our gratitude to the organizers of StatusCode for providing us with the opportunity to participate in the hackathon and showcase our project, Jeevandayak. <br> 
Special thanks to the developers of solidity, node.js, express.js, ganache, ethereum, html, css and bootstrap for their invaluable contributions to the technologies that powered our project. <br>
...
![Alt Text](app/src/images/demo.png)
